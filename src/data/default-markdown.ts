...
### Founding Engineer (Contract) | Founding Engineer | May 2026
...
\`React (Next.js)\` \`Node.js\` \`TypeScript\` \`WebSockets\` \`Redis\` \`PostgreSQL\` \`Docker\` \`VPS\` \`Better Auth\`

### Pageup People (Clinch) | Software Engineer | Oct 2023 – Jun 2025
...
\`React (Next.js)\` \`Node.js\` \`GraphQL\` \`CakePHP\` \`WebSockets\` \`Redis\` \`Elasticsearch\` \`GCP\` \`MySQL\` \`Jira\` \`Inngest\` \`n8n\` \`Docker\` \`Playwright\` \`Jest\`

### MobileKraft | Software Engineer | Sep 2022 – Jul 2023
> Full-stack web and mobile development for enterprise asset tracking
...
\`React\` \`Flutter\` \`Node.js\` \`Express\` \`Redis\` \`YAML\` \`MongoDB\` \`TypeScript\` \`WebSockets\` \`JIRA\` \`Playwright\` \`Jest\`

### Himalayan Techies | Software Engineer | Dec 2019 – Jul 2022
...
\`React\` \`Node.js\` \`Express.js\` \`JavaScript\` \`TypeScript\` \`GraphQL\` \`Laravel\` \`MySQL\` \`Apache Server\` \`Git\` \`Docker\`

## Education

### Kingston University | MSc | Software Engineering with Management Studies | 2023
### Patan Multiple Campus | BSc | Computer Science & IT | 2019
`;
